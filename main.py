...
class SolverGUI(tk.Tk):
    ...
    def draw_frame2(self, num_regions):
        ...
        self.num_stars_entry = tk.Entry(self.frame1, width=2)
        self.num_stars_entry.pack()
        solve_button = tk.Button(self.frame2, text='Solve!',command=lambda: self.solve())
        solve_button.pack() 
    ...
    def solve(self):
        self.num_stars = self.num_stars_entry.get()
